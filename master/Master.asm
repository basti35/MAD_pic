...
;	IN QUESTO CASO NON UTILIZZIAMO GLI INTERRUPT
	...
	bcf PIE3,WAKIE 	;disabilito gli interrupt attivati da attivitˆ del bus
...
;qui ci andrebbero i controlli ai bit FILHIT dei RXBnCON
	...
	banksel RXB0CON
	bcf RXB0CON,7; azzero il flag che mi indica che il buffer 0 è pieno. così possiamo attendere un altro messaggio ne caso in cui i galleggianti non siano ancora ok
